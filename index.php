...
<html lang="fr">
	<head>
		...
		<script src="mab_framework/init.js"></script>
	...
	<body style="width: 100vw; height: 1000vh;">
		...
		<script defer type="module" src="js/countdown.js?h=<?=time();?>"></script>
		...
		<style>
			#test-lb > img { width: 200px; }
		</style>

		<div id="test-lb">
			<img class="mab_lightbox" lb-id="mab" src="https://i.pinimg.com/originals/63/25/f7/6325f7e7d1f9168402881db1c054261d.jpg"><br />
			<img class="mab_lightbox" lb-id="mab" src="https://www.wallpapertip.com/wmimgs/9-97325_ultra-hd-wallpaper-8k-resolution-nature-nature-in.jpg"><br />
		</div>
		<br /><br />
		...
		<script defer type="text/javascript" src="js/animate_wheel.js?h=<?=time();?>"></script>
